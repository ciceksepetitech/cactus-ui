...
<InfoContainer>
  The Portal component mounts its content in a specific area of the DOM. Default renders to the end of the body tag. But the render area can be determined by ref or id.
</InfoContainer>
